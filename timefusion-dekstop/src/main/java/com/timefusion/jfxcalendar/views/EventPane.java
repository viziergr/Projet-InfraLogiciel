...
import com.timefusion.jfxcalendar.controllers.EventDetailPaneController;
import com.timefusion.jfxcalendar.dialog.DialogHandler;
...
public class EventPane extends VBox {
  ...
  public EventPane(CalendarEvent event) {
    ...
    removeButton.setGraphic(
      new FontAwesome().create(FontAwesome.Glyph.REMOVE).size(18)
    );
    editButton.setGraphic(
      new FontAwesome().create(FontAwesome.Glyph.PENCIL).size(18)
    );
