...
public class JFXCalendar extends StackPane {
  ...
  public JFXCalendar(CalendarEventManager eventManager) {
    getStylesheets()
      .add(
        this.getClass()
          .getResource(
            "/com/timefusion/jfxcalendar/style/CalendarScheduler.css"
          )
          .toExternalForm()
      );
  ...
  private void updateDate() {
    ...
    dateLabel.setText(
      CalendarEvent.MONTHS[selectedDate.getMonthValue() - 1] +
      " " +
  ...
  private void initLeftPane() {
    ...
    FontAwesomeIconView starView = new FontAwesomeIconView(
      FontAwesomeIcon.STAR
    );
    FontAwesomeIconView flagView = new FontAwesomeIconView(
