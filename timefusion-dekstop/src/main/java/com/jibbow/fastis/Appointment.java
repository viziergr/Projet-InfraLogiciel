...
public class Appointment {
  ...
  public Appointment(LocalDate date, StringProperty title) {
    this.intervalProperty =
      new SimpleObjectProperty<>(new TimeInterval(date, date));
  ...
  public Appointment(
    ObjectProperty<TimeInterval> interval,
      ...
      intervalProperty()
        .set(
          new TimeInterval(
            LocalDateTime.of(
              LocalDate.ofYearDay(
                startTimeProperty().get(ChronoField.YEAR),
                startTimeProperty().get(ChronoField.DAY_OF_YEAR)
              ),
              LocalTime.MIN
            ),
            LocalDateTime.of(
              LocalDate.ofYearDay(
                endTimeProperty().get(ChronoField.YEAR),
                endTimeProperty().get(ChronoField.DAY_OF_YEAR)
              ),
              LocalTime.MAX
            )
          )
