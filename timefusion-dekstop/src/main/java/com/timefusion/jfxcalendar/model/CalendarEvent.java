...
import com.timefusion.jfxcalendar.validation.DataValidator;
...
public class CalendarEvent {
  ...
  public static final String[] DAYS_FULL_NAMES = {
    "Monday",
    "Tuesday",
    "Wednesday",
    "Thursday",
  ...
  public static final String[] DAYS_SHORT_NAMES = {
    "Mon",
    "Tue",
    "Wed",
    "Thu",
  ...
  public static final String[] DAYS_NAMES_LETTERS = {
    "M",
    "T",
    "W",
    "T",
    ...
    if (type == ONE_TIME_EVENT) {
      ...
      if (periodicType == CalendarEvent.PER_WEEK) {
        ...
        if (placeInMonth == CalendarEvent.START_OF_MONTH) {
          ...
          return (
            localDate.getDayOfMonth() == month.atEndOfMonth().getDayOfMonth()
          );
        }
      } else if (periodicType == CalendarEvent.PER_YEAR) {
        return (
          localDate.getDayOfMonth() == getYearlyDateDay() &&
