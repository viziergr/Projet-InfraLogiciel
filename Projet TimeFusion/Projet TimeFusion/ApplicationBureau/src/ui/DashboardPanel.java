    ...
    private void displayEvents() {
        ...
        try {
            ...
            for (Event event : allEvents) {
                tableModel.addRow(new String[]{event.getStartTime().getDayOfWeek().getDisplayName(TextStyle.FULL, getLocale()), event.getStartTime().format(formatter), event.getEndTime().format(formatter), event.getDescription()});
            }
        } catch (Exception e) {
