...
public class NavigationCalendar extends VBox {
  ...
  public NavigationCalendar() {
    ...
    navigationPane
      .getChildren()
      .addAll(dateLabel, emptyPane, prevMonthButton, nextMonthButton);
  }
  ...
  public void refreshCalendar() {
    ...
    LocalDate firstOfMonthDate = LocalDate.of(
      selectedYear,
      selectedMonthIndex,
      1
    );
    ...
    for (int i = 0; i <= firstDayIndex; i++) {
      String dayIndexStr = String.valueOf(
        lenghtOfPrevMonth - firstDayIndex + i
      );
