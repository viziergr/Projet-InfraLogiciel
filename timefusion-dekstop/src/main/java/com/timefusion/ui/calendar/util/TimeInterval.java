...
public class TimeInterval {
  ...
  public boolean overlaps(TimeInterval other) {
    return (
      Duration
        .between(getEndDateTime(), other.getStartDateTime())
        .isNegative() &&
  ...
  public boolean startsBefore(TimeInterval other) {
    return !Duration
      .between(getStartDateTime(), other.getStartDateTime())
      .isNegative();
  }
  ...
  public boolean endsAfter(TimeInterval other) {
    return Duration
      .between(getEndDateTime(), other.getEndDateTime())
      .isNegative();
  }
  ...
  public boolean containsTime(Temporal time) {
    return (
      !Duration.between(startDateTime, time).isNegative() &&
